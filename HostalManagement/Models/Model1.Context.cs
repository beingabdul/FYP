...
namespace HostalManagement.Models
{
    ...
    public partial class HostalManagementDB01Entities : DbContext
    {
        public HostalManagementDB01Entities()
            : base("name=HostalManagementDB01Entities")
        {
        }
        ...
        public virtual DbSet<tbl_ExtraMealMenu> tbl_ExtraMealMenu { get; set; }
        public virtual DbSet<tbl_WeeklyMealMenu> tbl_WeeklyMealMenu { get; set; }
        public virtual DbSet<UserRole> UserRoles { get; set; }
        public virtual DbSet<Weekday> Weekdays { get; set; }
    
        public virtual int DropBillRecord(Nullable<int> stdId)
        {
            var stdIdParameter = stdId.HasValue ?
                new ObjectParameter("stdId", stdId) :
                new ObjectParameter("stdId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("DropBillRecord", stdIdParameter);
        }
    
        public virtual ObjectResult<getExtraMessing_Result> getExtraMessing()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getExtraMessing_Result>("getExtraMessing");
        }
    
        public virtual ObjectResult<getMenuToday_Result> getMenuToday(string toady)
        {
            var toadyParameter = toady != null ?
                new ObjectParameter("toady", toady) :
                new ObjectParameter("toady", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getMenuToday_Result>("getMenuToday", toadyParameter);
        }
        ...
        public virtual ObjectResult<getTheMonthyReportOrderbyStudent_Result> getTheMonthyReportOrderbyStudent(Nullable<int> rid, Nullable<int> mid)
        {
            var ridParameter = rid.HasValue ?
                new ObjectParameter("rid", rid) :
                new ObjectParameter("rid", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getTheMonthyReportOrderbyStudent_Result>("getTheMonthyReportOrderbyStudent", ridParameter, midParameter);
        }
        ...
        public virtual ObjectResult<getWeeklyMealMenu01_Result> getWeeklyMealMenu01()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getWeeklyMealMenu01_Result>("getWeeklyMealMenu01");
        }
    }
}
